...
<style type="text/css">
	*{ margin:0; padding:0;}
	...
	.ans-headImg img{ border-radius:50%;}
	...
	.ans-page .enabled:hover{ background-color:#14191e; color:#fff;}
        	...
        	<div class="after-customer">
        		...
        		<div class="personal" id="personalInfo">
                    ...
                    <div class="per-bottom">
                    	<a href="editUserInfo.jsp" class="setinfo">个人设置</a><a href="exit.action" class="exit">退出</a>
                    </div>
            	</div>
        	</div>
        </s:else>
    	...
    	<div class="leftwraper">
            ...
            <div class="add-ques">
            	...
            	<form action="addCritique.action" method="post">
	                ...
	                <div class="add-input"><input type="text" name="content" /></div>
	                <div class="answer">
            ...
            <s:iterator value="#request.allCri" id="cri">
	            <div class="ques-answer">
	                ...
	                <div class="helpMes">
	                    <p><s:property value="#cri.content" /></p>
	                </div> 
                	...
                	<div class="replyArea">
                		<s:iterator value="#request.ansMap[#cri.id]" id="ans" status="sta">
			                <div class="showAns">
			                	<a href="#" class="ans-headImg"><img src="user/tigger/images/cus.jpg" /></a>
			                    <div class="ans-person">
			                        <a href="#"><s:property value="#request.userList[#ans.userId]" />:</a>
			                        <span><s:property value="#ans.content" /></span>
			                        <div class="ans-bottom"><span class="reply">回复</span><span class="reply-time"><s:property value="#ans.date" /></span></div>
			                    </div>
			                </div>
		                </s:iterator>
		                <div class="ans-page" id="ans-page">
		                	<s:if test="#request.ansPageMap[#cri.id].hasPrePage">
			           			<a href="#" class="enabled">首页</a>
			                	<a href="#" class="enabled">上一页</a>
			                	<s:bean name="org.apache.struts2.util.Counter" id="counter">
			           				<s:param name="first" value="1" />
			           				<s:param name="last" value="#request.ansPageMap[#cri.id].currentPage - 1" />
				           			<s:iterator status="count">
				           				
				           				<a href="#" class="enabled"><s:property value="#count.index  + 1" /></a>
				           			</s:iterator>
			           			</s:bean>
		           			</s:if>
		           			<s:else>
		           				<a href="#" class="active enabled"><s:property value="#request.ansPageMap[#cri.id].currentPage" /></a>
		           				<s:if test="#request.ansPageMap[#cri.id].hasNextPage">
				           			<s:bean name="org.apache.struts2.util.Counter" id="counter">
				           				<s:param name="first" value="#request.ansPageMap[#cri.id].currentPage + 1" />
				           				<s:param name="last" value="#request.ansPageMap[#cri.id].totalPage" />
					           			<s:iterator status="count">
					           				<a href="#" class="enabled"><s:property value="#count.index  + #request.ansPageMap[#cri.id].currentPage + 1" /></a>
					           			</s:iterator>
				           			</s:bean>
				           			<a href="#" class="enabled">下一页</a>
		            	...
		            	<div class="add-reply">
		                    <h3>添加回答</h3>
	                    	<input type="hidden" class="critiqueId" value="<s:property value='#cri.id' />"/>
		                    <input type="hidden" class="user" value="<s:property value='#session.username' />"/>
	...
	<div class="login-wrap">
        ...
        <div class="register-content" id="regCon">
            <div class="user">
                ...
                <input type="text" id="regusername" class="username" name="username"/>
            </div>
            <div class="user">
                <p><img src="images/annotation.jpg" />请设置密码:</p>
                <input type="password" id="regpassword" class="pwd"  name="password"/>
            </div>
            <div class="user">
                <p><img src="images/annotation.jpg" />请确认密码:</p>
                <input type="password" id="repassword" class="pwd"  name="password"/>
            </div>
            <div class="user">
            ...
            <div class="protocol">
                <label><input type="checkbox" />我已阅读并同意</label><span><a href="#">《用户注册协议》</a></span>
            </div>
          `	<div class="login-btn">
